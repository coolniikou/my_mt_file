...
Localized language for exiftool tag descriptions, etc.  If the specified
language isn't available, the option is not changed.  May be set to undef to
...
HtmlDumpBase, IgnoreMinorErrors, Lang, MakerNotes, ScanForXMP, TextOut,
Unknown and Verbose.
...
Charset, CoordFormat, DateFormat, Duplicates, Exclude, Group#, Lang, List,
