package JSONAccessRanking::L10N::ja;

use strict;
use base 'JSONAccessRanking::L10N::en_us';
use vars qw( %Lexicon );
...
%Lexicon = (
	...
	'as_SettingTitle' => 'Google Analytics 基本情報',
    ...
    'as_Google_Analytics_Maxresult' => 'エントリー最大表示数（訪問数昇順）',
